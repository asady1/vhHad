...
presel = "(dijetmass_corr>800&triggerpassbb>0.&jetVID>0.&&jetHID>0&jetVpmass<65&jetVpmass>45&(jetVtau21+(0.063*log(jetVpmass*jetVpmass/jetVpt)))<0.55)"
tag = "jetHpmass>105&jetHpmass<135&jetHbbtag>0.6&"+presel
antitag = "jetHpmass>105&jetHpmass<135&jetHbbtag<0.6&"+presel
#jetVID>0.&&jetHID>0



DATA = DIST("DATA", "tree_data_VH_alphCR.root","mynewTree","1.")
DistsWeWantToEstiamte = [DATA]
Hbb = Alphabetizer("Analysis_Unblinding", DistsWeWantToEstiamte, [])
var_array = ["jetHpmass", "jetHbbtag", 30,50,200, 200, -1.1, 1.1]
...
FILE = TFile("outputs/CR_output.root", "RECREATE")
FILE.cd()
